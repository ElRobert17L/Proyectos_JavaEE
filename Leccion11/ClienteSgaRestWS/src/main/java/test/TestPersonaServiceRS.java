...
public class TestPersonaServiceRS {
    ...
    public static void main(String[] args) {
        ...
        //Agregar un persona (metodo post)
        Persona nuevaPersona = new Persona();
        nuevaPersona.setNombre("Carlos");
        nuevaPersona.setApellido("Miranda");
        nuevaPersona.setEmail("cramires@mail.com");
        nuevaPersona.setTelefono("5547884152");
        ...
        Persona personaModficar = personaRecuperada;
        personaModficar.setApellido("Ramirez");
        String pathId = "/" + personaModficar.getIdPersona();
        invocationBuilder = webTarget.path(pathId).request(MediaType.APPLICATION_XML);
        response = invocationBuilder.put(Entity.entity(personaModficar, MediaType.APPLICATION_XML));
        System.out.println("");
